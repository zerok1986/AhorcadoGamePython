"""
This is a free improvement of the Word Guesser game proposed as a Final project
example. This game is called AHORCADO GAME (in Python, of course!), and it can
